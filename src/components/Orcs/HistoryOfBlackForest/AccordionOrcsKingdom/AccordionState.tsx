...
<div className={classes.accordionItemContent}>
  <div className={classes.pictures}>
    ...
    <div className={classes.contentScroll}>
      ...
      <p><strong>
       Никто достоверно не знает откуда появилась раса орков на континенте. Известно лишь что она существовала ещё до эпохи зимы,
       но когда на Танах обрушился катаклизм, все зеленокожие как будто растворились. Даже старейшие из них, не знают ничего о судьбе своих предков.
       Поговаривают будто бы орки, одна из первых цивилизаций зародившейся в этом мире. Так как следы их обитания находят практически везде, где только можно представить.
       Когда земля начала оттаивать ото льда. Под пригорьем Медвежьих вершин, в недрах земли,
       ...
       окутывал огромные стволы чащобы. Только те немногие прорывавшиеся лучи солнца, сквозь кроны деревьев,
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
      ...
      <p><strong> 
       ...
       Для того чтобы строительство и обустройство быта шло эффективней. Бригадиры преступили к набору в свои группы,
       мастеров разной направленности. Позже когда масштабы поселений росли и требовалось постоянное обслуживание.
       Понадобилось община объединяющая их всех в единый организм, направляющая рабочих туда, где это было нужно.
      </strong></p>
    </div>
          </div>
        ),
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
        ...
        <p><strong>
          ...
          Те же в свою очередь обязались оставлять процент от краж в  казне сообщества . Но это был первый шаг в наведении порядка.
          ...
          Какое то время беспорядки продолжались по инерции, но после избрания новым вождём жестокого и бескомпромиссного Родзарика.
          Такие одиночки не имея у себя за спиной крепкой опоры, в наказание теряли не только награбленное, но и жизни.
          Хармуку же доверили управление капиталом. Ставшим в итоге казной всего Чёрного леса.
        </strong></p>
  </div>
  </div>
        ),
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
        ...
        <p><strong>
          ...
          Противостоять такой мощи орки не могли, и поселения сгорали одно за другим. Ближайший к горам лес выгорел полностью,
          лишь болота не дали продвинуться пламени вглубь. Группы отправившиеся на помощь собратьям, практически не обнаружили выживших.
          По большинству обгоревших тел зеленокожих, можно было понять, что погибли они в муках или же были казнены.
          Ярость от увиденного захлестнула весь Чёрный лес, общины взбунтовались и требовали жёсткого ответа.
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
        <h2>Первый король</h2>
        <p><strong>
          У орков никогда не было правителя. Все вопросы по управлению жизнедеятельности страны,
          решались главами общин. Что иногда приводило к неразберихе. Агрессия гномов обнажила уязвимое место в общинном порядке.
          После вероломного нападения, первый хранитель духов Норгуз, созвал совет у Чёрной скалы.
          ...
          Как будто всё чернолесье задышало в одном темпе и звуки природы стихли, прислушиваясь к этому дыханию.
          Каждый из предводителей желал стать единовластным королём. Спустя долгие споры,
          ...
          выпала честь стать Родзарику, главе грабителей, мародёров и воров. Не колеблясь, он провозгласил во всеуслышание,
