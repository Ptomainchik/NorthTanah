        ...
        <div>
            <div className={classes.contentModal1}>
                ...
                <span>
                  ...
                  у кого можно было хоть чем-нибудь поживиться. Но самым опасным и непредсказуемым из них был Родзарик, 
                  за что и стал вождём, а позже был провозглашён первым королём Чёрного Леса.
                </span>
            </div>
            <div className={classes.contentModal2}>  
                ...
                <span>
                  ...
                  где оставались брошенные жилища и имущество, - именно там появлялись банды мародёров, 
                  которыми заправлял жадный и ненасытный к чужому добру Фругеш.
                </span>
            </div>    
            <div className={classes.contentModal3}>
                ...
                <span>
                  ...
                  Он проворачивал дела как заправский стратег, а не просто щупал карманы. 
                  Созданию казны в Чернолесье и объединению банд все должны быть обязаны ему.  
                </span>
            </div>
        </div>
