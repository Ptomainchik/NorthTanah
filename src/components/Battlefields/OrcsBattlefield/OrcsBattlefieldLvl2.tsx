...
export const OrcsBattlefieldLvl2 = () => {
    ...
    const handleOrcAttack = () => {
        ...
        else if (dwarfHealth <= 700 && dwarfHealth >= 200 && damageMultiplier !== null) {
        ...
        else if (dwarfHealth <= 920 && dwarfHealth >= 420 && damageMultiplier !== null) {
        ...
        else if (dwarfHealth <= 1720 && dwarfHealth >= 1120 && damageMultiplier !== null) {
            setShowSkilAngryDwarfImg(false)
        } 
    ...
    return (
        <div className={classes.orcsBattlefield}>
            ...
            <div className={classes.unitsFlex}>
                ...
                {showMessage && <div className={classes.textMessageDwarves}><h2>Гном:</h2><p>Ха-ха! Слабаки.</p></div>}
                {showMessage2 && <div className={classes.textMessageDwarves}><h2>Гном:</h2><p>Упрямые идиоты!</p></div>}
                {showMessage3 && <div className={classes.textMessageDwarves}><h2>Гном:</h2><p>Вы за это заплатите!</p></div>}
