...
<div className={classes.accordionItemContent}>
 ...
 <div className={classes.contentScroll}>
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
      ...
      <p><strong> 
      В далекие столетия когда добыча золотоносной руды обрела сумасшедшие объёмы, прозванной золотой паникой. Гномы погружались всё глубже в недра вершин, в поисках больших богатых месторождений. Они обнаружили на западе хребта омывающемся водами озера, подгорье с затопленными природными тоннелями.
      По берегам озера у расщелин горы было найдено множество золотоносного песка. Тогда инженеры разработали план по отводу воды от тоннелей подгорья. Построив защитные дамбы и опустошив подземелья от воды.
  ...
  <div className={classes.contentScroll} style={{position: "absolute", top: "45%"}}>
        ...
        <p><strong>
          ...
          Это не могло повторяться вечно, иначе король потерял бы уважение у своих подданных.
          Узнав о беде, Доронг Сапфир решил положить конец этой угрозе и направил войска для усмирения агрессоров на юге.
