        ...
        <div className={classes.contentModal1}>
            <img title="Вакшиг" className={classes.imageHeadCommunities} src={Brigadier} alt="Orc Head Brigadier" style={{border: "solid rgb(255, 193, 21) 0.3vw"}}/>
                ...
                <span>
                  ...
                  Таким мастером, умеющим не только создавать, но и организовывать работу других, стал Вакшиг. 
                  Под его опытным началом строительство и ремёсла развивались стремительно.
                </span>
        </div>
    </div>
