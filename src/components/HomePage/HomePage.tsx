...
<div className={classes.choice}>
    <div className={classes.choiceTitle}>
        <span>Tanah</span>
        <p>
            Танах - это огромный континент, населенный разнообразными существами, расами и фракциями. 
            Каждая из них ведет свой уникальный образ жизни, устанавливает свои законы и правила.
